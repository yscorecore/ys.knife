...
namespace YS.Knife
{
    ...
    public class SearchCondition
    {
        ...
        {
            return new SearchCondition() { OpType = OpType.SingleItem, FieldName = fieldName, SearchType = searchType, Value = value };
        }
        ...
        public SearchCondition AndAlso(SearchCondition s)
        {
            ...
            {
                return new SearchCondition() { OpType = OpType.AndItems, Items = new List<SearchCondition>() { this, s } };
            }
        }
        public SearchCondition AndAlso(string fieldName, SearchType searchType, object value)
        {
            return AndAlso(new SearchCondition() { OpType = OpType.SingleItem, FieldName = fieldName, SearchType = searchType, Value = value });
        }
        public SearchCondition OrElse(SearchCondition s)
        {
            ...
            {
                return new SearchCondition() { OpType = OpType.OrItems, Items = new List<SearchCondition>() { this, s } };
            }
        }
        public SearchCondition OrElse(string fieldName, SearchType searchType, object value)
        {
            return OrElse(new SearchCondition() { OpType = OpType.SingleItem, FieldName = fieldName, SearchType = searchType, Value = value });
        }
