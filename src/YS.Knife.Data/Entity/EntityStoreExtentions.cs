...
//        }
//        public static R Max<T, R>(this IEntityStore<T> store, Expression<Func<T, bool>> conditions, Func<T, R> fieldSelector)
//              where T : class
//        {
//            return store.Query(conditions).Max(fieldSelector);
//        }
//        public static R Min<T, R>(this IEntityStore<T> store, Expression<Func<T, bool>> conditions, Func<T, R> fieldSelector)
//              where T : class
//        {
//            return store.Query(conditions).Max(fieldSelector);
//        }
