...
namespace System.Text
{
    ...
    /// </summary>
    /// <example>
    /// Scanf.Parse("Hello,world","Hello,%s")
    /// </example>
    public static class Scanf
    {
        public static List<object> Parse(string input, string pattern)
        {
            ScanFormatted scaner = new ScanFormatted();
            scaner.Parse(input, pattern);
            return scaner.Results;
        }
        /// <summary>
