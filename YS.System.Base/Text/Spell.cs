...
namespace System.Text
{
    ...
    public sealed class Spell
    {
        ...
        /// 获取汉字的汉语拼音
        /// </summary>
        /// <param name="strChinese">输入的汉字串</param>
        /// <param name="options">拼写转换的选项,SpellOptions枚举值,可组合</param>
        /// <returns></returns>
        public static string MakeSpellCode(string strChinese, SpellOptions options)
        {
                    ...
                    default:
                        {
                            ...
                            {
                                str = _spellMusicCode[num2].ToUpper().Substring(0, 1);
                            }
                            else
                            {
                                str = _spellMusicCode[num2].ToUpper();
                            }
                            goto Label_017A;
                        }
                }
            ...
            Label_017A:
                ...
                continue;
            Label_018A:
                if (((((options & SpellOptions.EnableUnicodeLetter) == SpellOptions.EnableUnicodeLetter) || ((bytes[index] >= 0x61) && (bytes[index] <= 0x7a))) || ((bytes[index] >= 0x41) && (bytes[index] <= 90))) || ((bytes[index] >= 0x30) && (bytes[index] <= 0x39)))
                {
                    char ch2 = (char)bytes[index];
                    builder.Append(ch2.ToString().ToUpper());
                }
                index++;
            }
        ...
        /// <param name="strChinese">输入的汉字串</param>
        /// <returns></returns>
        public static string MakeSpellCode(string strChinese)
        {
            return MakeSpellCode(strChinese, 0);
        }
    }
