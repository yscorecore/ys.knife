...
namespace YS.Knife.Rest.Api.Client.Generator
{
    public class ActionDescriptor
    {
        ...
        {
            HttpMethodAttribute methodAttribute = methodInfo.GetCustomAttribute<HttpMethodAttribute>(true);
            if (methodAttribute == null)
            {
                throw new ArgumentException($"The method must define a {nameof(HttpMethodAttribute)}.");
            }
