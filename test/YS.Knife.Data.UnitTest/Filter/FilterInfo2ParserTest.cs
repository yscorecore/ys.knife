...
namespace YS.Knife.Data.Filter
{
    ...
    public class FilterInfo2ParserTest
    {
        ...
        [DataRow("a.where(b.c.d!=\"e\")=null", "a.where(b.c.d != \"e\") == null")]
        [DataRow("a.where((((b.c!=\"e\")or(c.e in [1 ,2]))))=null", "a.where((b.c != \"e\") or (c.e in [1,2])) == null")]
        [DataRow("a.where(d.where(f=true).count()>1) = null", "a.where(d.where(f == true).count() > 1) == null")]
        [DataRow("a.where((((b.c!=\"e\")or(c.e in [1 ,2]))))=a.where((((b.c!=\"e\")or(c.e in [1 ,2]))))", "a.where((b.c != \"e\") or (c.e in [1,2])) == a.where((b.c != \"e\") or (c.e in [1,2]))")]
        [DataRow("user.scores.func(score).add2(user.scores.where(class=\"shuxue\").count()).add2(5)=100", "user.scores.func(score).add2(user.scores.where(class == \"shuxue\").count()).add2(5) == 100")]
